...
ExactAnalysis <- function() {
  ...
  # 2. P(Bus 2 leaves the main station at time 3) = P(L1 = 1, L2 = 2) + P(L2 = 2, L1 = 1) = P(L1 = 1) * P(L2 = 2) + P()
  P2 <- p[1] * p[2] + p[2] * p[1]

  # 3. P(W = 1 | L1 = 1) = P(L2 = 1, L3 = 2 | L1 = 1) = P(L2 = 1, L3 = 2)
  P3 <- p[1] * p[1]
...
print(ExactAnalysis())
print(busSim(5, c(0.5, 0.5), 2, 1, 3, 1, 5000))